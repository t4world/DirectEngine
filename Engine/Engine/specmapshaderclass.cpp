...
bool SpecMapShaderClass::InitializeShader(ID3D11Device * device, HWND hwnd, WCHAR * vsShaderFile, WCHAR * psShaderFile)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vsShaderFile, NULL, NULL, "SpecMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS,
	...
	result = D3DX11CompileFromFile(psShaderFile, NULL, NULL, "SpecMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS,
...
bool SpecMapShaderClass::SetShaderParameters(ID3D11DeviceContext * deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView ** textureArray, D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor, D3DXVECTOR3 cameraPosition, D3DXVECTOR4 specularColor, float specularPower)
{
	HRESULT result;
